...
const VERSION_HISTORY = [
  {
    ...
    date: '2026-06-20',
    changes: [
      '新增正式測驗模式（固定內科 1 題 ＋ 外科 1 題）',
      '新增雙題模式（A：內外各一／B：任意抽兩題／C：自選兩題）',
      '新增自選模式（自由組合 1–4 站）',
      '計時模式：共用計時（全程）與分站計時（每站獨立）',
      '外科創傷流程全面改為 XABCDE（含頸椎保護）',
      '新增情境：頭部外傷',
      '新增情境：手掌割傷',
      '新增情境：斷肢傷（大量出血）',
      '新增止血帶流程（獨立評分大項）',
      '新增斷肢保存流程（獨立評分大項）',
      '強化重大缺失（critical）判定，套用於 XABCDE 與止血流程',
      '測驗結果頁：各站明細 ＋ 綜合分級（加權平均）',
      '測驗紀錄獨立儲存，歷史頁新增「測驗紀錄」分頁',
      '評分卡片重構為共用元件（ScoreCards）',
    ],
  },
  {
    version: 'v1.1.1',
